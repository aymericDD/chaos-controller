...
type BPFCgroupIterOrder C.uint

const (
	BPFIterOrderUnspec BPFCgroupIterOrder = 0
	BPFIterSelfOnly BPFCgroupIterOrder = 1
	BPFIterDescendantsPre BPFCgroupIterOrder = 2
	BPFIterDescendantsPost BPFCgroupIterOrder = 3
	BPFIterAncestorsUp BPFCgroupIterOrder = 4
)
